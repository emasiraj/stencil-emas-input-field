...
const NAMESPACE = 'stencil-emas-input-field';
...
const patchBrowser = async () => {
    ...
    // @ts-ignore
    const importMeta = (typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('core-9d17b03c.js', document.baseURI).href));
