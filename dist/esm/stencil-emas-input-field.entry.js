...
const StencilEmasInputField = class {
    ...
    render() {
        return h("div", { id: "stencilEmasInputField" }, h("div", { class: "content" }, h("p", { class: "title" }, this.fieldName), h("div", { class: "mainInput" }, h("input", { id: "inputField", class: "inputField", placeholder: this.placeholderText, type: "search", list: "data", onChange: (event) => this.handleInputChange(event), value: this.inputValue }), this.dropdownValues
